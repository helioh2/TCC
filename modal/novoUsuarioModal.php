<center>
        ...
        <label>Nome</label><br><input  name="nome"  class="text-success center-block "  type="text" id="nomeModal" value = ""><br>
        <label>E-mail</label><br><input class="text-success center-block"  name="email" type="text" id="emailModal" value = ""><br>
